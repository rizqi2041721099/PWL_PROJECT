...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Role</h1>
                        ...
                        <li class="d-inline-block me-2 mb-1">
                            <div class='form-check'>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="check-all" class="form-check-input form-check-success"
                                        name="customCheck">
                                                    ...
                                                    <div class='form-check'>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" value="{{ $value->id }}"
                                                                id="permission_{{$loop->iteration}}" name="permission[]"
                                                                class="form-check-input form-check-success"
                                                                name="customCheck" @if( in_array($value->id,
                                                            $rolePermissions) ) checked="1" @endif>
